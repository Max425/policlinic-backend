        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doctors_Surveys_SurveyId",
                        column: x => x.SurveyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Records_Operators_OperatorId",
                        column: x => x.OperatorId,
                        principalTable: "Operators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Records_Surveys_SurveyId",
                        column: x => x.SurveyId,
                        principalTable: "Surveys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_SurveyId",
                table: "Doctors",
                column: "SurveyId");

            migrationBuilder.CreateIndex(
                name: "IX_Records_OperatorId",
                table: "Records",
                column: "OperatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Records_SurveyId",
                table: "Records",
                column: "SurveyId");
